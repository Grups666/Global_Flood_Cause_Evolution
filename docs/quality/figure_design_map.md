...
| 02 Direct catchment trends | Map all estimable slopes and robust individual trends | zero-centered blue–neutral–orange color; robust trends emphasized |
| 03 Individual evidence checks | Separate p values from sensitivity stability | paired bars and opposing-direction counts |
